...
# APPID = "sjh"  # 西溪测试
# APPSECRET = "wjltestsjh"
APPID = "3b08076f4bf36e0929fcb5e50f4xxyxc"
APPSECRET = "dface-xxyxc"
# APPID = "doormen"     #西安
# APPSECRET = "e3deb2ebce429926072c86703825cfbf"
# APPID = "46a0770fbfe73a930a3802cca5eb2003"   #宁波
...
def regAndSend (mobile,tickId):
    ...
    # mobile = "18627169820"
    remark = "test"
    name ="%e7%9f%b3%e6%95%99%e4%bc%9a"
    timestamp = get_now_time ()
...
if __name__ == "__main__":
    # user_register_mobile(mobile="18627168326")
    ...
    point_update (mobile='17826853131',point='500')
    # login_check ()
    # ticket_detail (tickId = '77841161221155705001948')
    # ticket_buy (mobile = '18627169820',tickId = '41541170725204638219420')
    # ticket_buy (mobile = '18607227615',tickId = '77841170104140345248948')
    # point_check_code ()
    # crm_recognizeMember()
    # regAndSend(mobile = '18847167741',tickId = '77841170330170111827490')
